...
namespace ASGay_Portfolio.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        //public ActionResult CreateReply(int SpecificCommentId)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        //reply.SpecificCommentId =   comment.Id ;
        //        //var SpecificComment= db.Comments.FirstOrDefault(s => s.Id == SpecificCommentId;
        ...
        //}
    //}
        public ActionResult CommentReply([Bind(Include = "Body, ")]Reply reply, int? CommentId) //Here I think I need to target the specific comment id that someone is replying to, but in
            //the view I am only being able to target and send the blog post id.  
        {
